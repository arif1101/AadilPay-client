...
export default function AdminOverview() {
  ...
  return (
    <div className="md:p-6 space-y-8 bg-gray-50 min-h-screen dark:bg-gray-900">
      <h1 className="text-3xl font-bold text-gray-900">Admin Dashboard</h1>

      {/* 🔹 Part 1: Balance Overview */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="shadow-md rounded-2xl bg-white dark:bg-gray-900">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-gray-800 dark:text-gray-100">Total Wallet Balance</CardTitle>
            <CircleDollarSign className="h-6 w-6 text-orange-500" />
          </CardHeader>
          {walletLoading ? (
            <Skeleton className="h-8 w-32 rounded-md mx-auto dark:bg-gray-700">loading..</Skeleton>
          ) : (
            <CardContent>
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                {totalWalletBalance} BDT
              </p>
            </CardContent>
          )}
        </Card>
        ...
        <Card className="shadow-md rounded-2xl bg-white dark:bg-gray-900">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-gray-800 dark:text-gray-100">Total Transaction Volume</CardTitle>
      ...
      <Tabs defaultValue="users" className="w-full">
        <TabsList className="grid w-full grid-cols-3 bg-orange-50 dark:bg-gray-800 rounded-lg p-1">
          <TabsTrigger
            value="users"
            className="data-[state=active]:bg-orange-500 data-[state=active]:text-white dark:data-[state=active]:bg-orange-400 dark:data-[state=active]:text-gray-900 rounded-md dark:text-gray-300"
          >
            Users
          </TabsTrigger>
          <TabsTrigger

      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-white border border-gray-200 p-10 rounded-2xl shadow hover:shadow-lg transition"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-orange-50 border border-orange-200 p-10 rounded-2xl shadow-lg hover:shadow-xl transition relative"
          >

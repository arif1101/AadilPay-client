...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-red-500 text-white py-24 px-6 text-center overflow-hidden">
        <motion.h1
        ...
        <div className="flex gap-4 justify-center mt-10">
          <Button
            size="lg"
            className="bg-white text-orange-600 font-semibold hover:bg-gray-100 rounded-xl px-8 py-6 shadow-lg"
          >
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-white bg-black text-white hover:bg-white/20 hover:text-white rounded-xl px-8 py-6"
          >
            Download App
          </Button>
        </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-white to-orange-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            >
              <div className="absolute -top-10 -right-10 w-32 h-32 bg-orange-100 rounded-full blur-2xl" />
      ...
      {/* Stats Section */}
      <section className="relative py-24 px-6 bg-gradient-to-r from-orange-600 to-red-600 text-white">
      ...
      <section className="py-24 px-6 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            { title: "Basic Wallet", price: "50৳", color: "from-orange-100 to-orange-50" },
            { title: "Smart Wallet", price: "150৳", color: "from-orange-200 to-orange-100" },
            { title: "Premium Wallet", price: "500৳", color: "from-red-200 to-orange-100" },
          ].map((plan, i) => (
            <Card key={i} className={`bg-gradient-to-br ${plan.color} shadow-lg rounded-3xl`}>
              ...
              <CardContent className="text-center">
                ...
                <Button className="mt-6 w-full rounded-xl bg-orange-600 hover:bg-orange-700">Choose Plan</Button>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="p-8 bg-white shadow-xl rounded-3xl border-l-4 border-orange-500"
            >
      ...
      {/* CTA Section */}
      <section className="relative py-24 px-6 bg-gradient-to-r from-orange-600 via-red-600 to-orange-500 text-white text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <Button size="lg" className="bg-white text-orange-600 font-semibold hover:bg-gray-100 rounded-xl px-10 py-6">
            Create Account Now
          </Button>
        </div>
      </section>
